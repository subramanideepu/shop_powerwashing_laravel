<template v-if="section === 'price'">
    ...
    <label for="margin_percentage" class="control-label">
        Margin Percentage
        <span class="text-muted">(Overrides category & global)</span>
    </label>
    ...
    <span
        ...
        v-if="errors.has('margin_percentage')"
        v-text="errors.get('margin_percentage')"
    ></span>
</div>
