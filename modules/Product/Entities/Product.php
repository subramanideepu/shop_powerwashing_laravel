...
class Product extends Model implements Sitemapable
{
    ...
    public function table(Request $request): ProductTable
    {
        $query = $this->newQuery()
            ...
            ->withBaseImage()
            ->withPrice()
            ->addSelect(['id', 'is_active', 'in_stock', 'manage_stock',  'price','selling_price', 'qty', 'created_at', 'updated_at'])
   ...
   public function clean(): array
{
    ...
    $data['margin_percentage'] = $this->margin_percentage;
...
protected function finalPrice(): Attribute
{
    return Attribute::make(
     get: fn () => calculate_margin_price($this)
    );
}
