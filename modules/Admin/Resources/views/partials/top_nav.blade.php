    ...
    <ul class="nav navbar-nav clearfix">
        ...
        <li class="user dropdown top-nav-menu pull-right">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                <span>{{ substr(optional($currentUser)->first_name ?? 'A', 0, 1) }}</span>
            ...
            <ul class="dropdown-menu">
                <li class="profile-details">
                    <span class="profile-first-letter">{{ substr(optional($currentUser)->first_name ?? 'A', 0, 1) }}</span>


                    <div class="profile-info">
                        <h4>
                            <span>{{ optional($currentUser)->first_name ?? 'Admin' }}
{{ optional($currentUser)->last_name ?? '' }}
</span>

                            <span><span>{{ optional($currentUser->roles->first())->name ?? 'Administrator' }}</span></span>
                        </h4>
