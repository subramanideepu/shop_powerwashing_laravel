<div class="row">
    <div class="col-md-8">
        ...
        {{ Form::number('global_margin_percentage',trans('setting::attributes.global_margin_percentage'),$errors,$settings,['min' => 0,'step' => 0.01,'labelCol' => 3,'required' => false,])}}
        {{ Form::number('share_1',trans('setting::attributes.share_1'), $errors, $settings,['min' => 0,'step' => 0.01,'labelCol' => 3,'required' => false,])}}

{{ Form::number(
    'share_2',
    trans('setting::attributes.share_2'),
    $errors,
    $settings,
    [
        'min' => 0,
